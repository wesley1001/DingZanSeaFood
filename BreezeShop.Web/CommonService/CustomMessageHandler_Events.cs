...
namespace BreezeShop.Web.CommonService
{
    ...
    public partial class CustomMessageHandler
    {
        ...
        public override IResponseMessageBase OnEvent_ClickRequest(RequestMessageEvent_Click requestMessage)
        {
            ...
            //            var uploadResult = Senparc.Weixin.MP.AdvancedAPIs.MediaApi.UploadTemporaryMedia(accessToken, UploadMediaFileType.thumb, HttpContext.Current.Server.MapPath("~/Images/Logo.jpg"));
            //            //设置音乐信息
            ...
            //            {
            //                Title = "OAuth2.0测试",
            //                Description = "点击【查看全文】进入授权页面。\r\n注意：此页面仅供测试（是专门的一个临时测试账号的授权，并非Senparc.Weixin.MP SDK官方账号，所以如果授权后出现错误页面数正常/情/况），测试号随时可能过期。请将此DEMO部署到您自己的服务器上，并使用自己的appid和secret。",
        ...
        public override IResponseMessageBase OnEvent_SubscribeRequest(RequestMessageEvent_Subscribe requestMessage)
        {
            ...
            var wxReplay = HttpContext.Current.Server.MapPath("~/wxreplay/default.txt");
            ...
            {
                OAuth2Type = "weixin",
                OAuthId = requestMessage.FromUserName
            });
            ...
            if (r.UserId > 0)
            {
                ...
                {
                    var req =
                        YunClient.Instance.Execute(new FindCashCouponRequest
                        {
                            PageSize = 1,
                            PageNum = 1,
                            BindUserId = r.UserId,
                    ...
                    if (req.TotalItem <= 0)
                    {
                        ...
                        if (req.CashCoupons != null && req.CashCoupons.Any())
                        {
                            YunClient.Instance.Execute(new BindCashCouponRequest
                            {
                                Id = req.CashCoupons[0].Id,
                                UserId = r.UserId
                            });
                        }
                    }
